...
INSERT INTO products
	(name,stock,wholesale_price, retail_price, brand,currency,thumbnail,picture)
	VALUES ('Remera Hombre Negra','32','42','8910','Nike','ARS','http://www.tenisglobal.com.ar/imagenes/ftp/Indumentaria%20HEAD/Remeras%20Alta%20HEAD/Remera%20HEAD%20Ryan/Remera%20Ryan%20Head%20I.jpg','http://www.tenisglobal.com.ar/imagenes/ftp/Indumentaria%20HEAD/Remeras%20Alta%20HEAD/Remera%20HEAD%20Ryan/Remera%20Ryan%20Head%20I.jpg');

INSERT INTO products
	(name,stock,wholesale_price, retail_price, brand,currency,thumbnail,picture)
	VALUES ('Remera Hombre Blanca','32','42','8910','Adidas','ARS','http://www.tenisglobal.com.ar/imagenes/ftp/Indumentaria%20HEAD/Remeras%20Club%20Branding%20HEAD%20HyM/Remera%20Head%20Branding/Remera%20HEAD%20Branding%20Celeste.jpg','http://www.tenisglobal.com.ar/imagenes/ftp/Indumentaria%20HEAD/Remeras%20Club%20Branding%20HEAD%20HyM/Remera%20Head%20Branding/Remera%20HEAD%20Branding%20Celeste.jpg');

INSERT INTO products
	(name,stock,wholesale_price, retail_price, brand,currency,thumbnail,picture)
	VALUES ('Remera Hombre Verde','32','42','8910','Nike','ARS','http://www.tenisglobal.com.ar/imagenes/ftp/Indumentaria%20HEAD/Remeras%20Alta%20HEAD/Chomba%20HEAD%20Jackson/Chomba%20HEAD%20III.jpg','http://www.tenisglobal.com.ar/imagenes/ftp/Indumentaria%20HEAD/Remeras%20Alta%20HEAD/Chomba%20HEAD%20Jackson/Chomba%20HEAD%20III.jpg');

INSERT INTO products
	(name,stock,wholesale_price, retail_price, brand,currency,thumbnail,picture)
	VALUES ('Remera Hombre Roja','32','42','8910','Nike','ARS','http://www.tenisglobal.com.ar/imagenes/ftp/Indumentaria%20HEAD/Remeras%20Alta%20HEAD/Chomba%20HEAD%20Jackson/Chomba%20HEAD%20I.jpg','http://www.tenisglobal.com.ar/imagenes/ftp/Indumentaria%20HEAD/Remeras%20Alta%20HEAD/Chomba%20HEAD%20Jackson/Chomba%20HEAD%20I.jpg');

INSERT INTO products
	(name,stock,wholesale_price, retail_price, brand,currency,thumbnail,picture)
	VALUES ('Remera Hombre Amarilla','32','42','8910','Adidas','ARS','http://www.modaydeporte.com.ar/wp-content/uploads/2009/01/Nike-Livestrong-Remera-Hombre.jpg','http://www.modaydeporte.com.ar/wp-content/uploads/2009/01/Nike-Livestrong-Remera-Hombre.jpg');

INSERT INTO products
	(name,stock,wholesale_price, retail_price, brand,currency,thumbnail,picture)
	VALUES ('Remera Mujer Rosa','32','42','8910','Puma','ARS','http://mla-d2-p.mlstatic.com/aerobics-pilates-yoga-ropa-deportiva-571101-MLA20269099455_032015-Y.jpg?square=null','http://mla-d2-p.mlstatic.com/aerobics-pilates-yoga-ropa-deportiva-571101-MLA20269099455_032015-Y.jpg?square=null');

INSERT INTO products
	(name,stock,wholesale_price, retail_price, brand,currency,thumbnail,picture)
	VALUES ('Remera Mujer Negra','32','42','8910','Puma','ARS','http://mla-s2-p.mlstatic.com/aerobics-pilates-yoga-ropa-deportiva-238501-MLA20363599848_072015-Y.jpg','http://mla-s2-p.mlstatic.com/aerobics-pilates-yoga-ropa-deportiva-238501-MLA20363599848_072015-Y.jpg');

INSERT INTO products
	(name,stock,wholesale_price, retail_price, brand,currency,thumbnail,picture)
	VALUES ('Remera Mujer Violeta','32','42','8910','brand 1','ARS','http://www.basset.com.ar/db_media/images/producto/215_chica.png','http://www.basset.com.ar/db_media/images/producto/215_chica.png');

INSERT INTO products
	(name,stock,wholesale_price, retail_price, brand,currency,thumbnail,picture)
	VALUES ('Remera Mujer Roja','32','42','8910','Adidas','ARS','http://mla-d2-p.mlstatic.com/indumentaria-tenis-padel-squash-22213-MLA7679972295_012015-Y.jpg?square=null','http://mla-d2-p.mlstatic.com/indumentaria-tenis-padel-squash-22213-MLA7679972295_012015-Y.jpg?square=null');

INSERT INTO products
	(name,stock,wholesale_price, retail_price, brand,currency,thumbnail,picture)
	VALUES ('Zepatillas Hombre Negra','32','42','8910','Nike','ARS','http://eyhombres.com/wp-content/uploads/2013/06/zapatillas-deportivas-hombre1.jpg','http://eyhombres.com/wp-content/uploads/2013/06/zapatillas-deportivas-hombre1.jpg');

INSERT INTO products
	(name,stock,wholesale_price, retail_price, brand,currency,thumbnail,picture)
	VALUES ('Zepatillas Hombre Azul','32','42','8910','Nike','ARS','http://www.zapatos.org/files/2012/04/zapatilla-nike-free-run.jpeg','http://www.zapatos.org/files/2012/04/zapatilla-nike-free-run.jpeg');

INSERT INTO products
	(name,stock,wholesale_price, retail_price, brand,currency,thumbnail,picture)
	VALUES ('Zepatillas Hombre Verde','32','42','8910','Puma','ARS','http://modadeportiva.com.ar/wp-content/uploads/2015/06/Nike-Zapatillas-deportivas-para-hombre-Fingertrap-Max-2015.jpg','http://modadeportiva.com.ar/wp-content/uploads/2015/06/Nike-Zapatillas-deportivas-para-hombre-Fingertrap-Max-2015.jpg');

INSERT INTO products
	(name,stock,wholesale_price, retail_price, brand,currency,thumbnail,picture)
	VALUES ('Zepatillas Hombre Azul','32','42','8910','Nike','ARS','http://i0.wp.com/www.fabricastextiles.com.ar/wp-content/uploads/2015/03/ZAPATILLAS-DEPORTIVAS-HOMBRE.jpg','http://i0.wp.com/www.fabricastextiles.com.ar/wp-content/uploads/2015/03/ZAPATILLAS-DEPORTIVAS-HOMBRE.jpg');

INSERT INTO products
	(name,stock,wholesale_price, retail_price, brand,currency,thumbnail,picture)
	VALUES ('Zepatillas Mujer Blanca','32','42','8910','Puma','ARS','http://mla-s1-p.mlstatic.com/zapatillas-402111-MLA20479312379_112015-Y.jpg','http://mla-s1-p.mlstatic.com/zapatillas-402111-MLA20479312379_112015-Y.jpg');

INSERT INTO products
	(name,stock,wholesale_price, retail_price, brand,currency,thumbnail,picture)
	VALUES ('Zepatillas Mujer Negra','32','42','8910','Nike','ARS','https://www.decathlon.es/media/834/8342041/classic_0ececb5aeda84a7591346cc74c07a02d.jpg','https://www.decathlon.es/media/834/8342041/classic_0ececb5aeda84a7591346cc74c07a02d.jpg');

INSERT INTO products
	(name,stock,wholesale_price, retail_price, brand,currency,thumbnail,picture)
	VALUES ('Zepatillas Mujer Verde','32','42','8910','Adidas','ARS','http://i51.twenga.com/moda/deportivas-mujer/nike-zapatillas-free-og-tp_4266409531051542559f.jpg','http://i51.twenga.com/moda/deportivas-mujer/nike-zapatillas-free-og-tp_4266409531051542559f.jpg');

INSERT INTO products
	(name,stock,wholesale_price, retail_price, brand,currency,thumbnail,picture)
	VALUES ('Zepatillas Mujer Celeste','32','42','8910','Puma','ARS','http://i0.wp.com/www.fabricastextiles.com.ar/wp-content/uploads/2015/03/ZAPATILLAS-DEPORTIVAS-HOMBRE.jpg','http://i0.wp.com/www.fabricastextiles.com.ar/wp-content/uploads/2015/03/ZAPATILLAS-DEPORTIVAS-HOMBRE.jpg');

INSERT INTO products
	(name,stock,wholesale_price, retail_price, brand,currency,thumbnail,picture)
	VALUES ('Pantalon Mujer Blanca','32','42','8910','Adidas','ARS','http://static.kiabi.es/images/pantalon-deportivo-de-felpa-gris-claro-mujer-tn226_1_lpr1.jpg','http://static.kiabi.es/images/pantalon-deportivo-de-felpa-gris-claro-mujer-tn226_1_lpr1.jpg');

INSERT INTO products
	(name,stock,wholesale_price, retail_price, brand,currency,thumbnail,picture)
	VALUES ('Pantalon Mujer Negra','32','42','8910','Adidas','ARS','http://pumaecom.scene7.com/is/image/PUMAECOM/568923_02_PNA?$PUMA_GRID$','http://pumaecom.scene7.com/is/image/PUMAECOM/568923_02_PNA?$PUMA_GRID$');
